      ...
      <div class="col-xs-12 pembatas">              
          <div class="row">
            <div class="register-form">
				...
				<a href="javascript:;" class="popover_bootbox img-thumbnail" rel="<?=base_url();?>uploads/gallery/<?=$this->participant->file_name?>" title="<?php echo $this->participant->name; echo ($this->participant->baby_name) ? ' & '.$this->participant->baby_name : ''?>">
